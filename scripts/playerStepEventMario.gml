...
if (!global.frozen && !frozen)
{
    ...
    if jumpColliderCreated == 0 && instance_number(objJumpColliderV2) < 1
    {
        jumpColliderCreated = instance_create(x, y, objJumpColliderV2)
        jumpColliderCreated.parent = id;
        jumpColliderCreated.bulletLimitCost = 0;
    }
}
